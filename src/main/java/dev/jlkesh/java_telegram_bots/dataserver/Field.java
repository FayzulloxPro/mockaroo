...
public class Field {
    ...
    public String getPatternAsCSV() {
        return fieldType.getRowAsCSV(fieldName, func.apply(min, max));
    }
    ...
    public FieldType.SQLData getPatternAsSQL() {
        return fieldType.getRowAsSQL(fieldName, func.apply(min, max));
