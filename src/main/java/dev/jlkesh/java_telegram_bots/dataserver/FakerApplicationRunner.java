...
import static dev.jlkesh.java_telegram_bots.dataserver.FakerApplicationService.BLACK_LIST;
...
public class FakerApplicationRunner {
    ...
    public static void main(String[] args) {
        ...
        builder.count(getValidRowCount(0));
    ...
    private static int getValidRowCount(int rowCount) {
        try {
...
//            return getValidRowCount();
     ...
     * {@link  dev.jlkesh.java_telegram_bots.dataserver.FileType#JSON};
     */
